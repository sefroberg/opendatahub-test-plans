...
- **Automation Repo:** [opendatahub-io/opendatahub-tests](https://github.com/opendatahub-io/opendatahub-tests)
- **Test Path:** `tests/model_serving/maas_billing/`
...
├── coverage-assessment.md   # Coverage assessment
└── test_cases/              # Test case index
...
3. **Check coverage:** See [coverage-assessment.md](coverage-assessment.md) for automation status
